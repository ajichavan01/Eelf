...
public class CreatureMetabolism {
    ...
    public CreatureMetabolism(Creature currentCreature) {
        ...
        // BP = 100 * maturity * pow(Size Ratio (gene), 2) - Max energy that can be
        // stored.
    ...
    public void SetEnergyUsedForMovement(float value) {
        ...
        // Metabolism Cost (E/S) = Default Metabolism Cost (setting) * Speed (gene) *
        // Size (2D)
    }
    ...
    // The energy cycle converts stomach content to energy, takes the value provided
    // by the SetEnergyUsed methods and
    // determines if the needed energy using processes get what is needed. Any
    ...
    public void EnergyCycle() {
        ...
        // TODO: Put energy usage in descending order of importance. (Think about adding
        // gene control for the priority)
